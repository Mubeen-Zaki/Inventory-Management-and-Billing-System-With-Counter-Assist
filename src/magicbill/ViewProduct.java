...
//        getProductData();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "name", "HSN", "desc", "price", "quantity", "tax"
            }
        ));
      ...
      /* if (jTextField1.getText() != null) {
           try (Connection con = ActionDao.getDBConnection()) {
            String Pname = JTextField1.getText();
                ...
                String query = "SELECT * FROM PRODUCTDETAIL WHERE PRODUCTNAME==Pname";
                       
                PreparedStatement pst = con.prepareStatement(query);
      
                pst.execute();
                Object[][] data = {name,HSN,desc,price,quantity,tax};
                String[] columns = {"Name", "HSN", "desc","price","quantity","price","quantity","tax"};
                DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
                model = new JTable(data,columns);
                this.dispose();
        ...
        while(rs.next())
        {
            model.addRow(new Object[]{rs.getString("Name"),rs.getString("HSN"),rs.getString("desc"), rs.getString("price"),rs.getString("quantity"),rs.getString("tax")});
